...
The methodology includes exploring of the vast data, combining data-sets and also includes graphs to understand about themes of Lego set and gives complexity of colours and number of parts of LEGO from the beginning till date. 10.
...
Our analysis highlights several key insights into LEGO’s evolution and product strategy: Firstly, LEGO focuses on certain themes, aligning with strong brand identities and wide audience appeal. Secondly, LEGO sets have obviously increased in complexity, reflecting better design, and building experiences. Finally, the most successful LEGO themes strategically balance innovation with accessibility, emphasizing thoughtful and inclusive design over mere complexity. This balanced approach not only maintains broad customer engagement but also supports sustained brand growth. As LEGO continues to evolve, understanding the interplay between complexity and accessibility will remain essential for its ongoing success.
